...
TAROLOGISTS = [
    ...
    },
    {
        ...
        "personality": (
            ...
            "Иногда задаёшь неудобный коучинговый вопрос вместо ответа. "
...
NO_CONTACTS_RULE = (
    ...
    "\n— НИКОГДА не пиши действия в скобках: (вздыхает), (пауза), (улыбается), (смотрит в карты), "
    "(тяжело вздыхает) и любые подобные — это не сценарий."
